...
class AddScheduleActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val sharedPreferences = this@AddScheduleActivity.getSharedPreferences("taikhoan",android.content.Context.MODE_PRIVATE)
    ...
    private fun showDialog() {
        val mBuilder : AlertDialog.Builder = AlertDialog.Builder(this@AddScheduleActivity)
    ...
    private fun timeDate() {
        ...
        date.init(mYear, mMonth - 1 , mDay, DatePicker.OnDateChangedListener { _, year, month, dayOfMonth ->
            mYear = year
            mMonth = month + 1
            mDay = dayOfMonth
        })
    ...
    private fun shortToast(string : String) {
        ...
        Toast.makeText(this@AddScheduleActivity, string, length).show()
    }
}
